...
/* Native-WASM high multiply helper. No JS BigInt is used for mulh. */
static const char* kMulhHelperBase64 =
    "AGFzbQEAAAABBgFgAn5+AX4DAwIAAAcXAgp="
    "bXVsaF9uYW1lAABq";
...
EM_JS(int, randomx_wasm_execute_module, (const uint8_t* module_ptr,
    ...
    try {
        ...
        if (!fn) {
            ...
            /*
             * High-multiply arithmetic is deliberately kept in WASM.
             * The generated rx_jit module already imports mulh_u64 and
             * mulh_s64; these imports are now backed by native WASM funcs
             * rather than JavaScript BigInt callbacks.
             */
            let mulh = Module.__randomxMulhHelper;
            if (!mulh) {
                /*
                 * This helper is a tiny WASM module containing unsigned and
                 * signed 64x64 -> high64 multiplication.  It is encoded as
                 * bytes below instead of using the newer mul_wide proposal,
                 * keeping compatibility with baseline browser WASM engines.
                 */
                const h = new Uint8Array([
                    ...
                    
                ]);
                const helperModule = new WebAssembly.Module(h);
